...
// =========================================================================
// 4. BOTÓN DE CONFIRMACIÓN EN APP.JS
// =========================================================================
...
// ✨ LÍNEA CORREGIDA Y SANITIZADA AQUÍ:
...
// =========================================================================
// 6. CONTROL INTELIGENTE DE AUDIO MEDIANTE API DE VISIBILIDAD ESTABLE
// =========================================================================
    ...
    if (reproductorMusica && !document.hidden && document.hasFocus()) {
        ...
        if (sobreAbierto) {
            ...
            reproductorMusica.play().catch(function(e) {
                console.log("Reanudación controlada de la música.");
            });
        }
    }
}
...
document.addEventListener("visibilitychange", function() {
    if (document.hidden) {
        ...
        setTimeout(reanudarMusicaSistema, 250);
    }
});

window.addEventListener("blur", pausarMusicaSistema);
window.addEventListener("focus", reanudarMusicaSistema);
